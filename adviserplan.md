...
> **Scope note:** this is the **v3 build plan** (single-agent, ship-on-day-1). The v4 multi-agent amendment built on top of it lives in [`docs/v4_multiagent.md`](./docs/v4_multiagent.md).
